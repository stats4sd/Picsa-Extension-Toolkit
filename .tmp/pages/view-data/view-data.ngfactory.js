...
import * as import0 from './view-data';
...
export var Wrapper_ViewDataPage = (function () {
    function Wrapper_ViewDataPage(p0) {
        this.changed = false;
        this.context = new import0.ViewDataPage(p0);
    }
    Wrapper_ViewDataPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_ViewDataPage;
}());
var renderType_ViewDataPage_Host = null;
var _View_ViewDataPage_Host0 = (function (_super) {
    __extends(_View_ViewDataPage_Host0, _super);
    function _View_ViewDataPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_ViewDataPage_Host0, renderType_ViewDataPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_ViewDataPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-view-data', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_ViewDataPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._ViewDataPage_0_4 = new Wrapper_ViewDataPage(this.parentInjector.get(import8.NavController));
        this._appEl_0.initComponent(this._ViewDataPage_0_4.context, [], compView_0);
        compView_0.create(this._ViewDataPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_ViewDataPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.ViewDataPage) && (0 === requestNodeIndex))) {
            return this._ViewDataPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_ViewDataPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._ViewDataPage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_ViewDataPage_Host0;
}(import1.AppView));
function viewFactory_ViewDataPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ViewDataPage_Host === null)) {
        (renderType_ViewDataPage_Host = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, [], {}));
    }
    return new _View_ViewDataPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var ViewDataPageNgFactory = new import10.ComponentFactory('page-view-data', viewFactory_ViewDataPage_Host0, import0.ViewDataPage);
var styles_ViewDataPage = [];
var renderType_ViewDataPage = null;
var _View_ViewDataPage0 = (function (_super) {
    __extends(_View_ViewDataPage0, _super);
    function _View_ViewDataPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_ViewDataPage0, renderType_ViewDataPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_ViewDataPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_6 = this.renderer.createText(null, 'view-data', null);
    ...
    _View_ViewDataPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_ViewDataPage0.prototype.detectChangesInternal = function (throwOnChange) {
    ...
    _View_ViewDataPage0.prototype.destroyInternal = function () {
        this._Content_10_4.context.ngOnDestroy();
    };
    return _View_ViewDataPage0;
}(import1.AppView));
export function viewFactory_ViewDataPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ViewDataPage === null)) {
        (renderType_ViewDataPage = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.None, styles_ViewDataPage, {}));
    }
    return new _View_ViewDataPage0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=view-data.ngfactory.js.map