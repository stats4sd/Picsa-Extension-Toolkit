...
var DEFAULT_URL = 'picsa-field-manual.pdf';
    ...
    if (contextMenuItems) {
      for (var i = 0, ii = contextMenuItems.length; i < ii; i++) {
        ...
        item.element.addEventListener('click', function (handler) {
          this.contextMenuOpen = false;
          handler();
      ***REMOVED***.bind(this, item.handler));
    ***REMOVED***
  ***REMOVED***
***REMOVED***
    ...
    setHash: function PDFLinkService_setHash(hash) {
      ...
      ***REMOVED***
        ...
        ***REMOVED*** else {
          ...
          ***REMOVED*** else if ((zoomArg === 'FitH' || zoomArg === 'FitBH') ||
  ...
  ***REMOVED***);
    ...
    if (this.toggleHandTool) {
      ...
      window.addEventListener('localized', function (evt) {
        ...
        ***REMOVED***
      ***REMOVED***.bind(this), function rejected(reason) {});
    ***REMOVED***.bind(this));
...
***REMOVED***,
  ...
  ***REMOVED***
    ...
    if (typeof file === 'string') { // URL
      ...
      parameters.url = file;
  ***REMOVED*** else if (file && 'byteLength' in file) { // ArrayBuffer
...
***REMOVED***,
  ...
  ***REMOVED***);
    ...
    ***REMOVED***;
      ...
      ***REMOVED*** else if (self.preferenceDefaultZoomValue) {
...
***REMOVED***
  ...
  if (store) {
    ...
    ***REMOVED***).catch(function() { /* unable to write to storage */ });
  ***REMOVED***);
***REMOVED***
  var href =
...
***REMOVED*** else if (evt.ctrlKey || evt.metaKey) {
