...
***REMOVED***;
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else if (viewHistory.forwardView === this) {
        return $window.history.go(1);
    ***REMOVED***
  ...
  function getParentHistoryObj(scope) {
    ...
    while (parentScope) {
      if (parentScope.hasOwnProperty('$historyId')) {
        ...
        return { historyId: parentScope.$historyId, scope: parentScope ***REMOVED***
    ***REMOVED***
      // nothing found keep climbing up
      parentScope = parentScope.$parent;
  ***REMOVED***
    // no history for the parent, use the root
    return { historyId: 'root', scope: $rootScope ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  return {
    ...
    ***REMOVED*** else if (backView && backView.stateId === currentStateId) {
    ...
    ***REMOVED*** else if (forwardView && forwardView.stateId === currentStateId) {
    ...
    ***REMOVED*** else if (currentView && currentView.historyId !== historyId &&
    ...
    ***REMOVED*** else {
      ...
      ***REMOVED***
        ...
        ***REMOVED*** else if (currentView.historyId !== hist.historyId) {
            direction = DIRECTION_ENTER;
  ...
  ***REMOVED***,
    ...
    clearHistory: function() {
      ...
      if (histories) {
        ...
        ***REMOVED*** else if (histories[historyId].destroy) {
...
***REMOVED***;
  ...
  ***REMOVED***
    ...
    var d = {
      ...
      ***REMOVED*** else if (direction == 'back') {
...
***REMOVED***;
  ...
  function setPlatformConfig(platformName, platformConfigs) {
    ...
    provider.platform[platformName] = {***REMOVED***
      ...
      if (n != PLATFORM && configObj.hasOwnProperty(n)) {
        if (angular.isObject(configObj[n])) {
          if (!isDefined(platformObj[n])) {
            platformObj[n] = {***REMOVED***
        ***REMOVED***
          addConfig(configObj[n], platformObj[n]);

      ***REMOVED*** else if (!isDefined(platformObj[n])) {
          platformObj[n] = null;
      ***REMOVED***
    ***REMOVED***
  ***REMOVED***
      ...
      ***REMOVED***,
        ...
        registerBackButtonAction: function(fn, priority, actionId) {
          ...
          if (!self._hasBackButtonHandler) {
            ...
            self.$backButtonActions = {***REMOVED***
...
***REMOVED***;
  ...
  ***REMOVED*** else if (popoverCSS.left + popoverWidth + POPOVER_BODY_PADDING > bodyWidth) {
...
.factory('$ionicPosition', ['$document', '$window', function($document, $window) {
  ...
  ***REMOVED*** else if ($window.getComputedStyle) {
...
***REMOVED***;
  ...
  return {
    ...
    position: function(element) {
      ...
      var offsetParentBCR = { top: 0, left: 0 ***REMOVED***
...
function($timeout, $document, $q, $ionicClickBlock, $ionicConfig, $ionicNavBarDelegate) {
  ...
  ionic.transition = ionic.transition || {***REMOVED***
    ...
    create: function(navViewCtrl, viewLocals, enteringView, leavingView, renderStart, renderEnd) {
      ...
      ***REMOVED***,
        ...
        loadViewElements: function(registerData) {
          ...
          ***REMOVED*** else if (isDefined(navViewActiveEleId) && viewEle.data(DATA_ELE_IDENTIFIER) === navViewActiveEleId) {
              leavingEle = viewEle;
          ***REMOVED***
      ...
      ***REMOVED***,
        ...
        emit: function(step, enteringData, leavingData) {
          ...
          ***REMOVED*** else if (enteringScope && leavingData && leavingData.viewId) {
      ...
      ***REMOVED***,
        ...
        ***REMOVED***
          ...
          ***REMOVED*** else if (viewElement.data(DATA_DESTROY_ELE) && navViewAttr(viewElement) != VIEW_STATUS_ACTIVE) {
...
***REMOVED***
  ...
  function viewState(locals) {
    return locals && locals.$$state && locals.$$state.self || {***REMOVED***
***REMOVED***
...
***REMOVED***;
  ...
  self.calcWidths = function(textAlign, isPreviousTitle) {
    ...
    for (x = 0; x < childNodes.length; x++) {
      ...
      ***REMOVED***
        ...
        if (isBackShown && c === backBtnEle) {
          ...
          ***REMOVED*** else if (b.nodeType == 3 && b.nodeValue.trim()) {
    ...
    ***REMOVED*** else if (c.nodeType == 3 && c.nodeValue.trim()) {
        // text node
  ...
  ***REMOVED*** else if (textAlign == 'right') {
...
***REMOVED***;
  ...
  ***REMOVED***;
    var computedStyle = window.getComputedStyle(self.scrollEl) || {***REMOVED***
    return {
      left: maxValues.left &&
...
***REMOVED***;
  ...
  ***REMOVED***
    ...
    ***REMOVED***,
      ...
      ***REMOVED*** else if (navEle[itemType]) {
  ...
  ***REMOVED***;
    ...
    ***REMOVED*** else if (itemType == 'rightButtons' ||
...
***REMOVED***;
  ...
  self.visibleBar = function(shouldShow) {
    if (shouldShow && !isVisible) {
      ...
      self.align();
  ***REMOVED*** else if (!shouldShow && isVisible) {
...
function($scope, $element, $attrs, $compile, $controller, $ionicNavBarDelegate, $ionicNavViewDelegate, $ionicHistory, $ionicViewSwitcher, $ionicConfig, $ionicScrollDelegate) {
  ...
  self.init = function() {
    ...
    var viewData = { name: navViewName, state: null ***REMOVED***
...
***REMOVED***;
  ...
  self.register = function(viewLocals) {
    ...
    var enteringView = $ionicHistory.getViewById(registerData.viewId) || {***REMOVED***
...
***REMOVED***;
  ...
  self.transitionEnd = function() {
    ...
    ***REMOVED*** else if (navViewAttr(viewElement) === 'leaving' || navViewAttr(viewElement) === VIEW_STATUS_ACTIVE || navViewAttr(viewElement) === VIEW_STATUS_CACHED) {
...
***REMOVED***;
  ...
  self.clearCache = function(stateIds) {
    ...
    ***REMOVED*** else if (navViewAttr(viewElement) == VIEW_STATUS_ACTIVE) {
        viewScope = viewElement.scope();
...
.controller('$ionicRefresher', [
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else if (deltaY > 0 && scrollParent.scrollTop === 0 && !isOverscrolling) {
    ...
    ***REMOVED*** else if (activated && lastOverscroll < ptrThreshold) {
        activated = false;
  ...
  ***REMOVED*** else if (window.navigator.msPointerEnabled) {
  ...
  ***REMOVED***
    ...
    self.__getScrollChild = function() { return scrollChild; ***REMOVED***
    self.__getScrollParent = function() { return scrollParent; ***REMOVED***
***REMOVED***
]);
...
***REMOVED***
  ...
  var scrollFunc = function(e) {
    var detail = (e.originalEvent || e).detail || {***REMOVED***
...
***REMOVED***;
  ...
  self.anchorScroll = function(shouldAnimate) {
    ...
    ***REMOVED*** while (curElm.attributes != self.element.attributes && curElm.offsetParent);
...
***REMOVED***;
  ...
  ***REMOVED*** else if (self.right && percentage < 0) {
...
***REMOVED***;
  ...
  ***REMOVED*** else if (!shouldFreeze && self.isScrollFreeze) {
      $ionicScrollDelegate.freezeAllScrolls(false);
  ***REMOVED***
...
***REMOVED***;
  ...
  ***REMOVED*** else if (self.left && self.left.isEnabled) {
      // set the left marget width if it should be exposed
      // otherwise set false so there's no left margin
      self.content.setMarginLeft(isAsideExposed ? self.left.width : 0);
  ***REMOVED*** else if (self.right && self.right.isEnabled) {
...
***REMOVED***;
  ...
  self.isDraggableTarget = function(e) {
    ...
    if (!menuEnabled) {
      var currentView = $ionicHistory.currentView() || {***REMOVED***
...
***REMOVED***;
  ...
  ***REMOVED*** else if (selectedTabIndex !== tabIndex) {
...
***REMOVED***;
  ...
  ***REMOVED***
    ...
    var heightData = {***REMOVED***
    var widthData = {***REMOVED***
    var computedStyleDimensions = {***REMOVED***
    var data = [];
    var repeatManager;
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      ***REMOVED***
    ***REMOVED*** else if (!heightData.dynamic && heightData.getValue) {
      ...
      if (hasData && widthData.computed) {
        ...
        if (!widthData.value) {
          throw new Error('collection-repeat tried to compute the width of repeated elements "' +
            ...
            'http://ionicframework.com/docs/api/directive/collectionRepeat/');
      ***REMOVED***
    ***REMOVED*** else if (!widthData.dynamic && widthData.getValue) {
        // If it's a constant with a getter (eg percent), we just refresh .value after resize
      ...
      if (isConstant) {
        ...
        if (attrValue.indexOf('%') > -1) {
          ...
          dimensionData.getValue = dimensionData === heightData ?
            ...
            function() { return Math.floor(decimalValue * scrollView.__clientWidth); ***REMOVED***
      ***REMOVED*** else {
...
function RepeatManagerFactory($rootScope, $window, $$rAF) {
  var EMPTY_DIMENSION = { primaryPos: 0, secondaryPos: 0, primarySize: 0, secondarySize: 0, rowPrimarySize: 0 ***REMOVED***
  ...
  return function RepeatController(options) {
    ...
    var getterLocals = {***REMOVED***
    var heightFn = heightData.getValue || function() { return heightData.value; ***REMOVED***
  ...
  ***REMOVED***;
    ...
    var widthFn = widthData.getValue || function() { return widthData.value; ***REMOVED***
  ...
  ***REMOVED***;
    ...
    ***REMOVED***
      ...
      var style = getComputedStyle(afterItemsNode) || {***REMOVED***
      var firstStyle = afterItemsNode.firstElementChild && getComputedStyle(afterItemsNode.firstElementChild) || {***REMOVED***
      var lastStyle = afterItemsNode.lastElementChild && getComputedStyle(afterItemsNode.lastElementChild) || {***REMOVED***
    ...
    ***REMOVED*** while ( ionic.DomUtil.contains(scrollView.__content, current = current.offsetParent) );

      var containerPrevNode = containerNode.previousElementSibling;
      var beforeStyle = containerPrevNode ? $window.getComputedStyle(containerPrevNode) : {***REMOVED***
    ...
    ***REMOVED***;
      ...
      this.updateRenderRange = function(scrollValue, scrollValueEnd) {
        ...
        if (oldRenderStartIndex === -1 || scrollValue === 0) {
          i = 0;
        // scrolling down
      ***REMOVED*** else if (scrollValue >= oldScrollValue) {
...
function($timeout, $controller, $ionicBind, $ionicConfig) {
  return {
    ...
    ***REMOVED***
      ...
      ***REMOVED***, function(className, oldClassName) {
  ...
  return {
    ...
    compile: function($element, $attr) {
      ...
      return function($scope, $element, $attrs, ctrls) {
        ...
        ***REMOVED***, function(isShown, wasShown) {
      ...
      for (var x = 0; x < tElement[0].childNodes.length; x++) {
        ...
        if (childNode.nodeType === 1) {
          if (hasIconClass(childNode)) {
            hasIcon = true;
        ***REMOVED*** else if (childNode.classList.contains('default-title')) {
            hasButtonText = true;
        ***REMOVED*** else if (childNode.classList.contains('previous-title')) {
            hasPreviousTitle = true;
        ***REMOVED***
      ***REMOVED*** else if (!hasInnerText && childNode.nodeType === 3) {
  ...
  return {
    ...
    compile: function(element, attr) {
      ...
      ***REMOVED***;
        ...
        var gestureOpts = { stop_browser_behavior: false ***REMOVED***
    ...
    compile: function(element, attr) {
      ...
      function prelink($scope, $element, $attrs, ctrl) {
        ...
        $scope.$on('$ionicExposeAside', function(evt, isAsideExposed) {
          if (!$scope.$exposeAside) $scope.$exposeAside = {***REMOVED***
...
function($animate, $timeout, $compile, $ionicSlideBoxDelegate, $ionicHistory, $ionicScrollDelegate) {
  ...
  ***REMOVED***,
    ...
    ***REMOVED***);
      ...
      ***REMOVED*** else if (!shouldFreeze && _this.isScrollFreeze) {
          $ionicScrollDelegate.freezeAllScrolls(false);
      ***REMOVED***
...
function($animate, $timeout, $compile) {
  ...
  ***REMOVED***,
    ...
    ***REMOVED***;
      ...
      var options = $scope.options || {***REMOVED***
  ...
  return {
    ...
    ***REMOVED***
      ...
      ***REMOVED***
        ...
        ***REMOVED*** else if (isTabContentAttached && childElement) {
...
function($ionicTabsDelegate, $ionicConfig) {
  return {
    ...
    compile: function(tElement) {
      ...
      return { pre: prelink, post: postLink ***REMOVED***
