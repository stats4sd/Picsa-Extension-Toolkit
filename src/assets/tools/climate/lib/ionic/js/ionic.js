...
window.ionic = window.ionic || {***REMOVED***
window.ionic.views = {***REMOVED***
  ...
  ***REMOVED***,
    ...
    elementIsDescendant: function(el, parent, stopAt) {
      ...
      do {
        ...
        current = current.parentNode;
    ***REMOVED*** while (current && current !== stopAt);
      return false;
  ***REMOVED***,
      ...
      if (ele && ele.setAttribute) {
        ...
        if (arguments.length > 2) {
          if (ele[dataKey] !== value) {
            ...
            ele[dataKey] = value;
        ***REMOVED***
      ***REMOVED*** else if (typeof ele[dataKey] == 'undefined') {
...
***REMOVED***;
  ...
  ionic.on = function() { ionic.EventController.on.apply(ionic.EventController, arguments); ***REMOVED***
  ionic.off = function() { ionic.EventController.off.apply(ionic.EventController, arguments); ***REMOVED***
  ionic.trigger = ionic.EventController.trigger;//function() { ionic.EventController.trigger.apply(ionic.EventController.trigger, arguments); ***REMOVED***
  ionic.onGesture = function() { return ionic.EventController.onGesture.apply(ionic.EventController.onGesture, arguments); ***REMOVED***
  ionic.offGesture = function() { return ionic.EventController.offGesture.apply(ionic.EventController.offGesture, arguments); ***REMOVED***
...
***REMOVED***;
  ...
  ionic.Gestures.EVENT_TYPES = {***REMOVED***
  ...
  // plugins namespace
  ionic.Gestures.plugins = {***REMOVED***
...
***REMOVED***;
  ...
  ***REMOVED***,
    ...
    register: function register(gesture) {
      ...
      var options = gesture.defaults || {***REMOVED***
...
***REMOVED***;
  ...
  ionic.Gestures.gestures = ionic.Gestures.gestures || {***REMOVED***
    ...
    handler: function holdGesture(ev, inst) {
      switch(ev.eventType) {
        case ionic.Gestures.EVENT_START:
          ...
          ***REMOVED***
        ***REMOVED***, inst.options.hold_timeout);
          break;
...
***REMOVED***;
  ...
  ***REMOVED***,
    ...
    ***REMOVED*** else if (!this.preventedFirstMove && ev.srcEvent.type == 'touchmove') {
...
***REMOVED***
      ...
      if (platform) {
        ...
        ***REMOVED***
          ...
          if (self.isAndroid() && version < 4.4) {
            grade = (version < 4 ? 'c' : 'b');
        ***REMOVED*** else if (self.isWindowsPhone()) {
            grade = 'b';
        ***REMOVED***
      ***REMOVED***
    ***REMOVED***
  ...
  ***REMOVED***,
    ...
    ***REMOVED*** else if (getParameterByName('ionicplatform')) {
        platformName = getParameterByName('ionicplatform');
    ***REMOVED*** else if (self.ua.indexOf('Edge') > -1) {
        platformName = EDGE;
    ***REMOVED*** else if (self.ua.indexOf('Windows Phone') > -1) {
        platformName = WINDOWS_PHONE;
    ***REMOVED*** else if (self.ua.indexOf('Android') > 0) {
        platformName = ANDROID;
    ***REMOVED*** else if (/iPhone|iPad|iPod/.test(self.ua)) {
        platformName = IOS;
    ***REMOVED*** else {
...
***REMOVED*** else if (tapActiveElement() === ele) {
    // already is the active element and has focus
    triggerFocusIn = true;

***REMOVED*** else if ((/^(input|textarea|ion-label)$/i).test(ele.tagName) || ele.isContentEditable) {
    triggerFocusIn = true;
    ele.focus && ele.focus();
    ele.value = ele.value;
    if (tapEnabledTouchEvents) {
...
(function(document, ionic) {
  ...
  var queueElements = {***REMOVED***   // elements that should get an active state in XX milliseconds
  var activeElements = {***REMOVED***  // elements that are currently active
...
***REMOVED*** else if (ionic.keyboard.isOpen) {
    keyboardShow();
***REMOVED***
}
...
function keyboardWaitForResize(callback, isOpening) {
  ...
  if (ionic.Platform.isAndroid() && ionic.Platform.version() < 4.4) {
    maxCount = 30;
***REMOVED*** else if (ionic.Platform.isAndroid()) {
    maxCount = 10;
***REMOVED*** else {
    maxCount = 1;
***REMOVED***
...
***REMOVED*** else if (!ionic.keyboard.isLandscape && !keyboardPortraitViewportHeight) {
...
var viewportTag;
var viewportProperties = {***REMOVED***
...
ionic.views.Scroll = ionic.views.View.inherit({
  ...
  ***REMOVED***;
    ...
    ***REMOVED***);
  ***REMOVED***, self.options.scrollEventInterval);
...
***REMOVED***,
  ...
  ***REMOVED*** else if (window.navigator.pointerEnabled) {
      // Pointer Events
...
***REMOVED***,
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else {
      ...
      ***REMOVED***, delay || self.options.scrollbarFadeDelay);
    ***REMOVED***
  ***REMOVED***
***REMOVED***,
...
***REMOVED***,
  ...
  */
  ...
  getRenderFn: function() {
    ...
    if ('MozAppearance' in docStyle) {
      engine = 'gecko';
  ***REMOVED*** else if ('WebkitAppearance' in docStyle) {
      engine = 'webkit';
  ***REMOVED*** else if (typeof navigator.cpuClass === 'string') {
      engine = 'trident';
  ***REMOVED***
  ...
  ***REMOVED*** else if (helperElem.style[transformProperty] !== undef) {
...
***REMOVED***,
  ...
  activatePullToRefresh: function(height, refresherMethods) {
    ...
    self.__refreshActivate = function() { ionic.requestAnimationFrame(refresherMethods.activate); ***REMOVED***
    self.__refreshDeactivate = function() { ionic.requestAnimationFrame(refresherMethods.deactivate); ***REMOVED***
    self.__refreshStart = function() { ionic.requestAnimationFrame(refresherMethods.start); ***REMOVED***
    self.__refreshShow = function() { ionic.requestAnimationFrame(refresherMethods.show); ***REMOVED***
    self.__refreshHide = function() { ionic.requestAnimationFrame(refresherMethods.hide); ***REMOVED***
    self.__refreshTail = function() { ionic.requestAnimationFrame(refresherMethods.tail); ***REMOVED***
...
***REMOVED***,
  ...
  ***REMOVED***
    ...
    ***REMOVED***, self.__refreshTailTime);
  ***REMOVED***, delay);
***REMOVED***,
...
***REMOVED***,
  ...
  ***REMOVED*** else {
    ...
    ***REMOVED*** else if (self.options.snapping) {
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      if (self.__enableScrollX) {
        ...
        ***REMOVED*** else if (scrollLeft > maxScrollLeft) {
      ...
      if (self.__enableScrollY) {
        ...
        if (scrollTop > maxScrollTop || scrollTop < 0) {
          ...
          if (self.options.bouncing || (self.__refreshHeight && scrollTop < 0)) {
            ...
            ***REMOVED*** else if (self.__refreshActive && scrollTop > -self.__refreshHeight) {
        ...
        ***REMOVED*** else if (scrollTop > maxScrollTop) {
        ...
        ***REMOVED***
      ***REMOVED*** else if (self.__refreshHeight && !self.__refreshHidden) {
...
***REMOVED***,
  ...
  ***REMOVED***
    ...
    if (self.__isDragging) {
      ...
      ***REMOVED***
    ***REMOVED*** else if ((timeStamp - self.__lastTouchMove) > 100) {
        self.__scrollingComplete();
    ***REMOVED***

  ***REMOVED*** else if (self.__decStopped) {
...
***REMOVED***,
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else if (scrollLeft > self.__maxDecelerationScrollLeft) {
        scrollOutsideX = self.__maxDecelerationScrollLeft - scrollLeft;
    ***REMOVED***

      if (scrollTop < self.__minDecelerationScrollTop) {
        scrollOutsideY = self.__minDecelerationScrollTop - scrollTop;
    ***REMOVED*** else if (scrollTop > self.__maxDecelerationScrollTop) {
...
***REMOVED***;
  ...
  ***REMOVED***
    ...
    if (e.target.classList.contains(ITEM_CONTENT_CLASS)) {
      content = e.target;
  ***REMOVED*** else if (e.target.classList.contains(ITEM_CLASS)) {
...
***REMOVED***);
  ...
  ***REMOVED***
    ...
    ***REMOVED*** else if (e.gesture.direction == "right") {
        restingPoint = 0;
    ***REMOVED***
  ...
  ReorderDrag.prototype._getReorderIndex = function() {
    ...
    ***REMOVED*** else if (i === 0) {
        if (dragOffsetTop < el.offsetTop + el.offsetHeight) {
          return i;
      ***REMOVED***
    ***REMOVED*** else if (dragOffsetTop > el.offsetTop - el.offsetHeight / 2 &&
...
***REMOVED***;
  ...
  ionic.views.ListView = ionic.views.View.inherit({
    ...
    ***REMOVED***
      ...
      self.onRefresh = opts.onRefresh || function() {***REMOVED***
      self.onRefreshOpening = opts.onRefreshOpening || function() {***REMOVED***
      self.onRefreshHolding = opts.onRefreshHolding || function() {***REMOVED***

      var gestureOpts = {***REMOVED***
...
ionic.views.Slider = ionic.views.View.inherit({
  ...
  ***REMOVED***
    ...
    // utilities
    var noop = function() {***REMOVED*** // simple no operation function
    var offloadFn = function(fn) { setTimeout(fn || noop, 0); ***REMOVED*** // offload a functions execution
    ...
    var browser = {
      ...
      transitions: (function(temp) {
        ...
        return false;
    ***REMOVED***)(document.createElement('swipe'))
  ***REMOVED***;
  ...
  ***REMOVED***;
    ...
    ***REMOVED*** else {
        ...
        window.onresize = function () { setup(); ***REMOVED*** // to play nice with old IE
    ...
    var Swiper = function (container, params, _scope, $compile) {
      ...
      ***REMOVED***
        ...
        s.loadImage = function (imgElement, src, srcset, checkForComplete, callback) {
          ...
          ***REMOVED*** else {//image already loaded...
                onReady();
          ***REMOVED***
      ***REMOVED***;
          ...
          ***REMOVED***,
            data: function (key, value) {
              ...
              ***REMOVED***
                    ...
                    for (var i = 0; i < this.length; i++) {
                        var el = this[i];
                        if (!el.dom7ElementDataStorage) el.dom7ElementDataStorage = {***REMOVED***
...
'use strict';
  ...
  ionic.views.Toggle = ionic.views.View.inherit({
    initialize: function(opts) {
      ...
      this.openPercent = -1;
      this.onChange = opts.onChange || function() {***REMOVED***
  ...
  ***REMOVED***,
    ...
    drag: function(e) {
      ...
      ionic.requestAnimationFrame(function () {
        ...
        ***REMOVED*** else if(px > self._dragInfo.triggerX) {
  ...
  ***REMOVED***,
    ...
    setOpenPercent: function(openPercent) {
      ...
      if(this.openPercent < 0 || (openPercent < (this.openPercent - 3) || openPercent > (this.openPercent + 3) ) ) {
        ...
        if(openPercent === 0) {
          this.val(false);
      ***REMOVED*** else if(openPercent === 100) {
          this.val(true);
      ***REMOVED*** else {
